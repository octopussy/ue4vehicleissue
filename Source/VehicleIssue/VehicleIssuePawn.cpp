...
#include "VehicleIssueWheelFront.h"
#include "VehicleIssueWheelRear.h"
...
const FName AVehicleIssuePawn::LookUpBinding("LookUp");
const FName AVehicleIssuePawn::LookRightBinding("LookRight");
const FName AVehicleIssuePawn::EngineAudioRPM("RPM");

#define LOCTEXT_NAMESPACE "VehiclePawn"

AVehicleIssuePawn::AVehicleIssuePawn()
{
	// Car mesh
	...
	// Wheels/Tyres
	// Setup the wheels
	Vehicle4W->WheelSetups[0].WheelClass = UVehicleIssueWheelFront::StaticClass();
	Vehicle4W->WheelSetups[0].BoneName = FName("PhysWheel_FL");
	Vehicle4W->WheelSetups[0].AdditionalOffset = FVector(0.f, -8.f, 0.f);

	Vehicle4W->WheelSetups[1].WheelClass = UVehicleIssueWheelFront::StaticClass();
	Vehicle4W->WheelSetups[1].BoneName = FName("PhysWheel_FR");
	Vehicle4W->WheelSetups[1].AdditionalOffset = FVector(0.f, 8.f, 0.f);

	Vehicle4W->WheelSetups[2].WheelClass = UVehicleIssueWheelRear::StaticClass();
	Vehicle4W->WheelSetups[2].BoneName = FName("PhysWheel_BL");
	Vehicle4W->WheelSetups[2].AdditionalOffset = FVector(0.f, -8.f, 0.f);

	Vehicle4W->WheelSetups[3].WheelClass = UVehicleIssueWheelRear::StaticClass();
...
void AVehicleIssuePawn::SetupPlayerInputComponent(class UInputComponent* InputComponent)
{
	// set up gameplay key bindings
	check(InputComponent);

	InputComponent->BindAxis("MoveForward", this, &AVehicleIssuePawn::MoveForward);
	InputComponent->BindAxis("MoveRight", this, &AVehicleIssuePawn::MoveRight);
	InputComponent->BindAxis(LookUpBinding);
	InputComponent->BindAxis(LookRightBinding);

	InputComponent->BindAction("Handbrake", IE_Pressed, this, &AVehicleIssuePawn::OnHandbrakePressed);
	InputComponent->BindAction("Handbrake", IE_Released, this, &AVehicleIssuePawn::OnHandbrakeReleased);
	InputComponent->BindAction("SwitchCamera", IE_Pressed, this, &AVehicleIssuePawn::OnToggleCamera);

	InputComponent->BindAction("ResetVR", IE_Pressed, this, &AVehicleIssuePawn::OnResetVR); 
}

void AVehicleIssuePawn::MoveForward(float Val)
{
	GetVehicleMovementComponent()->SetThrottleInput(Val);

}

void AVehicleIssuePawn::MoveRight(float Val)
{
	GetVehicleMovementComponent()->SetSteeringInput(Val);
}

void AVehicleIssuePawn::OnHandbrakePressed()
{
	GetVehicleMovementComponent()->SetHandbrakeInput(true);
}

void AVehicleIssuePawn::OnHandbrakeReleased()
{
	GetVehicleMovementComponent()->SetHandbrakeInput(false);
}

void AVehicleIssuePawn::OnToggleCamera()
{
	EnableIncarView(!bInCarCameraActive);
}

void AVehicleIssuePawn::EnableIncarView(const bool bState)
{
...
void AVehicleIssuePawn::Tick(float Delta)
{
...
void AVehicleIssuePawn::BeginPlay()
{
...
void AVehicleIssuePawn::OnResetVR()
{
#ifdef HMD_INTGERATION
...
void AVehicleIssuePawn::UpdateHUDStrings()
{
...
void AVehicleIssuePawn::SetupInCarHUD()
{
...
void AVehicleIssuePawn::UpdatePhysicsMaterial()
{
